...
const Points = () => {
   ...
   useEffect(() => {
      async function loadPosition() {
         ...
         if (status !== 'granted') {
            Alert.alert('Ooopss....', 'We need your permission to obtain your location');
            return;
         }
   ...
   return (
      <>
         <View style={styles.container}>
            ...
            <Text style={styles.description}>Find on the map a waste collection point.</Text>
            ...
            <View style={styles.mapContainer}>
               {initialPosition[0] !== 0 && (
                  ...
                  >
                     {  Object.keys(points).length !== 0 && points.map(point => (
                           <Marker 
                              key={String(point.id)}
